...
export default function selectGroupList({ updateGroupId, groupIds }: GroupSelectProps) {
    ...
    useEffect(() => {
        const fetchGroups = async () => {
            ...
            setFetchedGroups(result.data.filter((group: allGroups) => !groupIds.includes(group.id)));
        };
        fetchGroups();
    }, []);
